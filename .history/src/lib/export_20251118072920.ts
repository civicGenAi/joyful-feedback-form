...
export const exportToPDF = async (
  ...
  // Note: Since we're using a real image, we'll use a placeholder and add the image via canvas
  // For now, we'll create a simple circle representation
  doc.setFillColor(255, 255, 255);
  doc.circle(19, 20, 8, 'F');
  
  // Logo icon representation (simplified)
